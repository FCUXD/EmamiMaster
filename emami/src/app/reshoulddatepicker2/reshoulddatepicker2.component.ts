...
@Component({
  selector: 'app-reshoulddatepicker2',
  templateUrl: './reshoulddatepicker2.component.html',
  styles: [`
  :host >>> .popover {
   color: #000;
   max-width: 692px;
...
export class Reshoulddatepicker2Component implements OnInit {
    ...
    if(date < new Date()){
     ...
     this.pass =day+"-"+(this.date.getMonth()+1)+"-"+this.date.getFullYear();
         ...
         this.currentDate = day;
          ...
          this.voted1.emit(new Date(thisDate2));
