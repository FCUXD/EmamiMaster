...
@Component({
  selector: 'app-pain-management-slider',
  templateUrl: './pain-management-slider.component.html',
  styleUrls: ['./pain-management-slider.component.css']
})
export class PainManagementSliderComponent implements OnInit {
