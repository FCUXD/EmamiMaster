...
@Component({
  selector: 'app-other-slider',
  templateUrl: './other-slider.component.html',
  styleUrls: ['./other-slider.component.css']
})
export class OtherSliderComponent implements OnInit {
  spinner=0;
  down(index){
