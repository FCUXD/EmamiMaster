...
@Component({
  selector: 'app-skindiseases',
  templateUrl: './skindiseases.component.html',
  styleUrls: ['./skindiseases.component.css']
})
export class SkindiseasesComponent implements OnInit {
