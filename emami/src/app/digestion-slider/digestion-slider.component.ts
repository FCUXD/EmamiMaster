...
@Component({
  selector: 'app-digestion-slider',
  templateUrl: './digestion-slider.component.html',
  styleUrls: ['./digestion-slider.component.css']
})
export class DigestionSliderComponent implements OnInit {
