...
@Component({
  selector: 'app-diabetes-slider',
  templateUrl: './diabetes-slider.component.html',
  styleUrls: ['./diabetes-slider.component.css']
})
export class DiabetesSliderComponent implements OnInit {
  spinner=0;
  down(index){
