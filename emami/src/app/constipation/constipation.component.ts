...
@Component({
  selector: 'app-constipation',
  templateUrl: './constipation.component.html',
  styleUrls: ['./constipation.component.css']
})
export class ConstipationComponent implements OnInit {
