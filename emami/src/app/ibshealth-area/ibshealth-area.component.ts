...
@Component({
  selector: 'app-ibshealth-area',
  templateUrl: './ibshealth-area.component.html',
  styleUrls: ['./ibshealth-area.component.css'],


})
export class IBSHealthAreaComponent implements OnInit {
