...
@Component({
  selector: 'app-search-product-slider',
  templateUrl: './search-product-slider.component.html',
  styleUrls: ['./search-product-slider.component.css']
})
export class SearchProductSliderComponent implements OnInit {
