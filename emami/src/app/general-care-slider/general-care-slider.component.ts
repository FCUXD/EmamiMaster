...
@Component({
  selector: 'app-general-care-slider',
  templateUrl: './general-care-slider.component.html',
  styleUrls: ['./general-care-slider.component.css']
})
export class GeneralCareSliderComponent implements OnInit {
